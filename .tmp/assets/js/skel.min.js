      ...
      document.addEventListener ? !function (e, n) {
        ...
        function t(t) {
          for (r = 1; t = n.shift();) t();
            ...
            i = document,
            a = "DOMContentLoaded",
            r = /^loaded|^c/.test(i.readyState);return i.addEventListener(a, e = function () {
        ...
        function e(t) {
          for (h = 1; t = i.shift();) t();
            ...
            h = f.test(r[l]);return r[d] && r[d](c, n = function () {
        ...
        if ("string" == typeof t) return t.indexOf(e);var n,
            i,
            a = e ? e : 0;if (!this) throw new TypeError();if (i = this.length, 0 === i || a >= i) return -1;for (0 > a && (a = i - Math.abs(a)), n = a; i > n; n++) if (this[n] === t) return n;return -1;
