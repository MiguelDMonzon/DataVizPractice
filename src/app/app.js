angular
  ...
  .component('app', {
    ...
    var data_chart1 = []
    $http.get("http://localhost:7001/data/prueba/prueba")
      .then((response) => {
        data_chart1.push(response.data)
    });

    $http.get("http://localhost:7001/data/prueba/prueba2")
      .then((response) => {
        data_chart1.push(response.data)
    });
    ...
    $http.get("http://localhost:7001/data/prueba/bitcoin")
      .then((response) => {
    ...
    $http.get("http://localhost:7001/data/prueba/marketcap")
      .then((response) => {
    ...
    $http.get("http://localhost:7001/data/prueba/all_criptocurrencies")
      .then((response) => {

        $http.get("http://localhost:7001/data/prueba/all_currencies_traditional")
          .then((response2) => {
